...
class ScheduleWorkCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'schedule:work2 {--run-output-file= : The file to direct <info>schedule:run</info> output to}';
    ...
    public function handle()
    {
        ...
        [$lastExecutionStartedAt, $executions] = [Carbon::now()->subMinutes(1000), []];
        ...
        while (true) {
            ...
            if (Carbon::now()->second === 0 &&
                ...
                $executions[] = $execution = Process::fromShellCommandline($command)->setTimeout(60*60*24*365);
