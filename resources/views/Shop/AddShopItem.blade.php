...
@section('title', "新增商品 | ".Config::get('app.name'))
@section('head')
    ...
    <main>
        <div class="container3">
            <div class="mt-5 shop-item-add">
                <h1 class="shop-item-add-title noto-serif-tc-bold">新增商品</h1>
                ...
                <form class="shop-item-add-form form-common"
                      ...
                      method="post">
                    <input type="submit" value="新增" class="btn btn-ripple btn-md-strip btn-color7">
                    @csrf
                    <div id="tab1" class="tab-content">
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid" autocomplete="ItemName" type="text" name="ItemName"
                                   required>
                        </div>
                        <div class="shop-item-add-form-item">
                            ...
                            <div class="w-1/2">
                                <div id="SC-mode-switcher" data-name="ItemStatus" data-onclick="true" class="switch">
                        ...
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid validate" data-method="number" data-numberofdigits="2"
                                   data-negative="false" data-step="5.00" value="0.00" type="text" name="ItemPrice"
                                   required>
                        </div>
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid validate" data-method="number" data-numberofdigits="2"
                                   data-negative="false" data-step="5.00" value="0.00" type="text" name="ItemLastPrice"
                                   required>
                        </div>
                        ...
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid validate" data-method="number" data-numberofdigits="0"
                                   data-negative="false" data-step="1" value="0" type="text" name="ItemMaxAmount"
                                   required>
                        </div>
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid validate" data-method="number" data-numberofdigits="0"
                                   data-negative="false" data-step="1" value="0" type="text" name="ItemAmount" required>
                        </div>
                        <div class="shop-item-add-form-item">
                            ...
                            <input class="w-1/2 form-solid validate" data-method="number" data-numberofdigits="0"
                                   data-negative="false" data-step="1" value="0" type="text" name="ItemPurchasesNum"
                                   required>
                        </div>
                        <div class="shop-item-add-form-item">
                            ...
                            <select data-width="50%" class="w-1/2 select2" name="ItemQuality">
                        ...
                        <div class="shop-item-add-form-item">
                            ...
                            <select data-width="50%" class="w-1/2 select2 form-solid" name="ItemQuality">
                    ...
                    <div id="tab2" class="!hidden tab-content">
                        <div class="flex flex-wrap">
                            ...
                            <x-head.tinymce-config name="ItemDescription"
                                                   ...
                                                   parent-class="w-full min-h-[700px]"></x-head.tinymce-config>
                        </div>
                    </div>
                    <div id="tab3" class="!hidden tab-content">
                        <div class="shop-item-add-form-item">
                            <label class="w-1/2 noto-serif-tc-bold" for="ItemBrand">品牌名</label>
                            <input class="w-1/2 form-solid" autocomplete="brand" type="text" name="ItemBrand">
                        </div>
                        <div class="shop-item-add-form-item">
                            <label class="w-1/2 noto-serif-tc-bold" for="ItemMPN">製造商零件編號</label>
                            <input class="w-1/2 form-solid" autocomplete="off" type="text" name="ItemMPN">
                        </div>
                        <div class="shop-item-add-form-item">
                            <label class="w-1/2 noto-serif-tc-bold" for="ItemSKU">庫存單位編號</label>
                            <input class="w-1/2 form-solid" autocomplete="off" type="text" name="ItemSKU">
                        </div>
                        <div class="shop-item-add-form-item">
                            <label class="w-1/2 noto-serif-tc-bold" for="ItemGTIN-13">全球商品貿易項目編號</label>
                            <input class="w-1/2 form-solid" autocomplete="off" type="text" name="ItemGTIN-13">
                        </div>
                        <div class="flex flex-wrap">
