...
@section('title', $i18N->getLanguage(ELanguageText::page_my_sharetables_title)." | ".Config::get('app.name'))
@section('head')
...
@section('content')
    ...
    <main>
        ...
        <div class="container1">
            ...
            <div class="panel-title-field gfont-noto-serif-tc-bold">{{ $i18N->getLanguage(\App\Lib\I18N\ELanguageText::page_my_sharetables_title) }}</div>
