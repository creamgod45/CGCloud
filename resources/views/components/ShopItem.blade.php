    ...
    <div class="shop-list">
        @foreach($inventorys as $key => $value)
            ...
            <div class="shop-item-padding">
                <div class="shop-item SI" data-add="#{{ $add_id }}" data-reduce="#{{ $reduce_id }}"
                     data-source="{{ $source }}">
                    ...
                    <div class="action-bar">
                        ...
                        <button id="{{ $add_id }}" class="btn btn-color7 btn-circle btn-ripple btn-cancel"><i
                                class="fa-solid fa-plus"></i>
                        </button>
                        <button id="{{ $reduce_id }}" class="btn btn-color7 btn-circle btn-ripple btn-cancel"><i
