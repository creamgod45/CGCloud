function ripple() {
    let elementNodeListOf = document.querySelectorAll('.btn-ripple');
    for (let elementNodeListOfElement of elementNodeListOf) {
        //button.addEventListener('click', createRipple);
        if (!elementNodeListOfElement.classList.contains('btn-rippled')) {
            elementNodeListOfElement.classList.add('btn-rippled');
